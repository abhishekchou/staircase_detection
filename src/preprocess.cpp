...
//  rotated_a.y = (a.y/std::tan(phi))*(std::tan(phi)-std::tan(theta));
//  rotated_b.y = rotated_a.y;
  rotated_a.y = 0;
  rotated_b.y = 0;
  rotated_a.z = a.z; rotated_b.z = b.z;
...
//    theta +=2*PI;
  ...
  ROS_WARN("Rotated y centroid = %f",rotated_a.y);
